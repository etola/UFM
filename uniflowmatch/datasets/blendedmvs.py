...
from uniflowmatch.datasets.utils.blendedmvs_module import BlendedMVSModule
...
class BlendedMVS(BaseStereoViewDataset):
    ...
    def __init__(self, *args, ROOT, pair_metadata_path, split=None, overfit_num_pairs=None, **kwargs):
        ...
        self.blendedmvs_info = BlendedMVSModule(ROOT)
        super().__init__(
            *args,
            **kwargs,
        )
    ...
    def _load_data(self, split, overfit_num_pairs):
        ...
        # Get valid sequences
        valid_seqs = self.blendedmvs_info.sequences
...
def get_parser():
    ...
    parser.add_argument(
        "-rd", "--root_dir", default="/uniflowmatch/data/blendedmvs_processed", type=str
    )
    parser.add_argument(
        "-pmp",
        "--pair_metadata_path",
...
if __name__ == "__main__":
    ...
    if args.viz:
        rr.script_setup(args, f"BlendedMVS_Dataloader")
